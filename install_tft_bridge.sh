...
install_bridge_files() {
    ...
    # Create configuration file in installation directory
    sudo tee "$BRIDGE_INSTALL_DIR/tft_bridge_config.sh" > /dev/null << EOF
#!/bin/bash
# TFT Bridge Configuration
# Generated by install script on $(date)
...
EOF
    ...
    sudo chmod +x "$BRIDGE_INSTALL_DIR/tft_bridge_config.sh"
